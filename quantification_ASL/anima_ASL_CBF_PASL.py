...
parser.add_argument('-TI1', '--TI1', type=float, required=True, help='TI1')
parser.add_argument('-TI2', '--TI2', type=float, required=True, help='TI2')
...
print("\n QUANTIFICATION...")
quantifCommand=[animaDir +"animaCBFEstimation_PASL", "-i", outASLPrefix + "_flow_mean.nii.gz", "--m0", outM0Prefix + "_reg.nii.gz", "-o", outASLPrefix + "_CBF.nii.gz", "-v", str(args.TI1), "-w", str(args.TI2), "-b", str(args.T1Blood), "-a", str(args.alpha), "-l", str(args.lambdaa), "-s", str(args.sDelay)]
