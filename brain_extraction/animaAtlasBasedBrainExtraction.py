...
for brainImage in sys.argv[1:] :
	...
	command = [animaPyramidalBMRegistration,"-m",atlasImage,"-r",brainImage,"-o",brainImagePrefix + "_rig.nrrd","-O",brainImagePrefix + "_rig_tr.txt","--sp","3"] + pyramidOptions
	call(command)

	command = [animaPyramidalBMRegistration,"-m",atlasImage,"-r",brainImage,"-o",brainImagePrefix + "_aff.nrrd","-O",brainImagePrefix + "_aff_tr.txt","-i",brainImagePrefix + "_rig_tr.txt","--sp","3","--ot","2"] + pyramidOptions
	call(command)

	command = [animaDenseSVFBMRegistration,"-r",brainImage,"-m",brainImagePrefix + "_aff.nrrd","-o",brainImagePrefix + "_nl.nrrd","-O",brainImagePrefix + "_nl_tr.nrrd","--sr","1"] + pyramidOptions
	call(command)

	command = [animaTransformSerieXmlGenerator,"-i",brainImagePrefix + "_aff_tr.txt","-i",brainImagePrefix + "_nl_tr.nrrd","-o",brainImagePrefix + "_nl_tr.xml"]
	call(command)

	command = [animaApplyTransformSerie,"-i",iccImage,"-t",brainImagePrefix + "_nl_tr.xml","-g",brainImage,"-o",brainImagePrefix + "_rough_brainMask.nrrd","-n","nearest"]
	call(command)

	command = [animaMaskImage,"-i",brainImage,"-m",brainImagePrefix + "_rough_brainMask.nrrd","-o",brainImagePrefix + "_rough_masked.nrrd"]
	call(command)

	brainImageRoughMasked = brainImagePrefix + "_rough_masked.nrrd"
	# Fine mask with masked brain
	command = [animaPyramidalBMRegistration,"-m",atlasImageMasked,"-r",brainImageRoughMasked,"-o",brainImagePrefix + "_rig.nrrd","-O",brainImagePrefix + "_rig_tr.txt","--sp","3"] + pyramidOptions
	call(command)

	command = [animaPyramidalBMRegistration,"-m",atlasImageMasked,"-r",brainImageRoughMasked,"-o",brainImagePrefix + "_aff.nrrd","-O",brainImagePrefix + "_aff_tr.txt","-i",brainImagePrefix + "_rig_tr.txt","--sp","3","--ot","2"] + pyramidOptions
	call(command)

	command = [animaDenseSVFBMRegistration,"-r",brainImageRoughMasked,"-m",brainImagePrefix + "_aff.nrrd","-o",brainImagePrefix + "_nl.nrrd","-O",brainImagePrefix + "_nl_tr.nrrd","--sr","1"] + pyramidOptions
	call(command)

	command = [animaApplyTransformSerie,"-i",iccImage,"-t",brainImagePrefix + "_nl_tr.xml","-g",brainImage,"-o",brainImagePrefix + "_brainMask.nrrd","-n","nearest"]
	call(command)

	command = [animaMaskImage,"-i",brainImage,"-m",brainImagePrefix + "_brainMask.nrrd","-o",brainImagePrefix + "_masked.nrrd"]
	call(command)
